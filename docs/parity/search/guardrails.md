...
1. focused regression coverage for multi-translation selection and grouped
   result totals
2. a tighter contract check around search option-to-query rerun wiring
3. a machine-readable snapshot of supported search scopes and word modes if the
   option surface expands materially
