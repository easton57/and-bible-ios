...
1. a machine-readable snapshot of Android-compatible sync keys and category names
2. shared-scheme inclusion, or equivalent standard runner coverage, for the
   dedicated workspace sync regression target
3. a focused XCUITest for the adopt-versus-create confirmation branch
